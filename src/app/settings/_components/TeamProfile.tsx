...
export default async function Navbar() {
  ...
  return (
    ...
    <nav className="sticky top-0 flex flex-col items-center justify-between border-b bg-blue-400 p-2 text-slate-50">      <div className="flex h-10 w-full flex-row items-center gap-12 px-6 py-8 pt-8">
